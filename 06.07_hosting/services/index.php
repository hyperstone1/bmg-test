...
if ($page[1] == "en") {
    ...
    $url_1 = "/en";
    $language = "EN";
    $lang["TITLE1"] = "Provided services";
    $lang["ZAYAVKA"] = "Submit your application";
    $lang["TEXT_NAD_SLAIDER"] = "TEXT_NAD_SLAIDER_EN";
    $lang["TITLE_SERVIS"] = "TITLE_SERVIS_EN";
} else {
    $APPLICATION->SetTitle("Услуги");
    $url_1 = "";
    $language = "RU";
    $lang["TITLE1"] = "Предоставляемые услуги";
    $lang["ZAYAVKA"] = "Оставить заявку";
    $lang["TEXT_NAD_SLAIDER"] = "TEXT_NAD_SLAIDER";
    $lang["TITLE_SERVIS"] = "TITLE_SERVIS";
...
<section class="services">
  ...
  <section class="services_summary">
    <?php $arElement = CIBlockElement::GetList(
        array("SORT" => "ASC"), // Сортировка элементов
        array("IBLOCK_ID" => 2, 'ACTIVE' => 'Y', "SECTION_ID" => false),
        false,
        array("nTopCount" => 1)
    );
    ...
    <div class="services_summary__container">
      <div class="services_summary__text">
        <div class="services_summary__text-title"><?=$lang["TITLE1"];?></div>
        <div class="services_summary__text-description">
          <?php
              echo $arProperties[$lang["TEXT_NAD_SLAIDER"]]['VALUE'];
          ?>
            <a href = "#down1" class="services_summary__btn">
              <div class="services_summary__btn-container">
              <div class="services_summary__btn-text_container">
              <span class="services_summary__btn-text"><?=$lang["ZAYAVKA"];?></span>
              </div>
              <div class="services_summary__btn-hover_container">
              <span class="text-hover"><?=$lang["ZAYAVKA"];?></span>
              </div>
              </div>
  ...
  <section class="services_list">
    <div class="services_list_container">
      <div class="services_list__title">
        <div class="services_list__title-title">
            <?php
                echo $arProperties[$lang["TITLE_SERVIS"]]['VALUE'];
                }
            ?>
        </div>
      </div>
	...
	array(
		...
		"PAGER_TITLE" => "Услуги",
		"PARENT_SECTION" => "",
		"PARENT_SECTION_CODE" => "vse-yslygi",
