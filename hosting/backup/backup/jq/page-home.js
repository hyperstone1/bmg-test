document.addEventListener('DOMContentLoaded', function () {
  ...
  function addSlider() {
    ...
    console.log(width);
    const navigation = document.querySelector('.swiper-nav') || null;
    const slider = document.querySelector('.swiper-slider') || null;
    const navigationArrowNext =
      document.querySelector('.swiper-slider .swiper-button-next') || null;
    const navigationArrowPrev =
      document.querySelector('.swiper-slider .swiper-button-prev') || null;
    ...
    if (width < 768) {
      ...
      if (navigation === null) {
        const swiperContainer = document.querySelector('.swiper-container') || null;
        const sliderBtnNext = document.querySelector('.swiper-button-next') || null;
        const sliderBtnPrev = document.querySelector('.swiper-button-prev') || null;
