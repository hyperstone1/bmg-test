...
<div class="portfolio_projects__projects-item">
    ...
    <div class="portfolio_projects__projects-img" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
        <img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"];?>" alt="" />
    </div>
    <div class="portfolio_projects__projects_text">
        <div class="portfolio_projects__projects_text-title"><?=$arItem["NAME"];?></div>
    ...
    <div class="portfolio_projects__projects-category">
        <div class="portfolio_projects__projects-category_gradient">
            <img src="/bitrix/templates/bmg/images/portfolio/category_gradient.webp" alt="" />
        </div>
        <span>
            <?php
        ...
        <button class="portfolio_projects__projects_show btn-show_more">
              <span class="portfolio_projects__projects_show-text btn-show_more--text"
              >Показать еще</span
              >
            <div class="portfolio_projects__projects_show-icon btn-show_more--icon">
                <svg
                        width="30"
                        height="16"
                        viewBox="0 0 30 16"
...
<div id="pag" class="portfolio_projects__projects_show btn-show_more">
    <?=$arResult["NAV_STRING"]?>
</div>
